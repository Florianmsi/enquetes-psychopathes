...
function getBonusScore() {
    return BONUS_CONFIG.reduce((total, bonus, i) => {
        ...
        if (answer && (answer.correct == true || answer.correct === "true")) {
...
function isBonusCorrect(answer) {
    if (!answer) return false;
    return answer.correct == true || answer.correct === "true";
}
...
function renderBonusLines() {
    ...
    BONUS_CONFIG.forEach((bonus, index) => {
        ...
        const isCorrect = answered ? (answered.correct == true || answered.correct === 'true') : false;
...
function updateBonusSummary() {
    ...
    const items = BONUS_CONFIG.map((bonus, i) => {
        ...
        const earned = answered && (answered.correct == true || answered.correct === 'true');
...
function checkBonusTrophy() {
    ...
    const allCorrect = BONUS_CONFIG.every((_, i) => isBonusCorrect(bonusAnswers[i]));
