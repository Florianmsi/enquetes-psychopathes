...
function showSection(sectionName) {
    ...
    if (sectionName === 'chapitres') {
        ...
        document.getElementById('sectionStatistiques').classList.add('active');
...
function answerBonusQuestion(questionId, answerIndex) {
    ...
    if (answeredCount === 10) {
        // Attendre 2 secondes puis fermer la modale et aller aux statistiques
        setTimeout(() => {
            closeBonusModal();
...
function updateBonusScoreDisplay() {
    ...
    if (answeredCount === 10) {
        ...
        completionMessage.innerHTML = `
            ...
            <p>Redirection vers les statistiques dans 2 secondes...</p>
        `;
